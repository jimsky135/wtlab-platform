...
export const en = {
	...
	integratedWorkspace: {
		...
		guest: {
			...
			login: {
				heading: 'Prototype sign-in',
				note: 'Prototype only, not an account system: one shared demo credential, no registration and no password recovery. Signing in gives you a fresh temporary workspace of your own; signing out deletes it.',
				usernameLabel: 'Username',
				passwordLabel: 'Password',
				loginButton: 'Sign in',
				logoutButton: 'Sign out',
				loggedIn: 'Signed in to a prototype guest session.',
