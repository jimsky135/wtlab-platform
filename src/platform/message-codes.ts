...
export const MESSAGE_CODES = [
	...
	// --- Supplier Dependency Radar: mode schema warnings (Sprint 009) ---
	'SUPPLIER_DEP_QUALIFICATION_TIME_UNKNOWN_WARNING',
	'SUPPLIER_DEP_SWITCHING_TIME_UNKNOWN_WARNING',
	'SUPPLIER_DEP_EXPOSURE_VALUE_MISSING_WARNING',
	'SUPPLIER_DEP_CRITICAL_STATUS_UNKNOWN_WARNING',
	'SUPPLIER_DEP_ALT_EXISTS_QUALIFICATION_UNKNOWN_WARNING',
	'SUPPLIER_DEP_CUSTOMER_APPROVAL_UNKNOWN_WARNING',
	'SUPPLIER_DEP_DELIVERY_RELIABILITY_MISSING_WARNING',
	'SUPPLIER_DEP_PERFORMANCE_HISTORY_MISSING_WARNING',

	// --- Supplier Dependency Radar engine narratives (src/tools/supplier-dependency-radar/analyze.ts) ---
	'SUPPLIER_DEP_WARNING_MODERATE',
	'SUPPLIER_DEP_WARNING_HIGH',
	'SUPPLIER_DEP_WARNING_CRITICAL',
	'SUPPLIER_DEP_ACTION_START_ALTERNATIVE_QUALIFICATION',
	'SUPPLIER_DEP_ACTION_REDUCE_SUPPLIER_CONCENTRATION',
	'SUPPLIER_DEP_ACTION_CREATE_SECOND_SOURCE_PLAN',
	'SUPPLIER_DEP_ACTION_REVIEW_CUSTOMER_APPROVAL_PATH',
	'SUPPLIER_DEP_ACTION_BUILD_TEMPORARY_BUFFER',
	'SUPPLIER_DEP_ACTION_MONITOR_DELIVERY_PERFORMANCE',
	'SUPPLIER_DEP_ACTION_NO_IMMEDIATE_ACTION',
] as const;
